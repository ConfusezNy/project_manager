                ...
                return (
                    ...
                    >
                        <div className="flex flex-col items-center mt-1 w-6 sm:w-8 flex-shrink-0">
                            <div
                                className={`relative z-10 h-4 w-4 sm:h-5 sm:w-5 rounded-full border-[3px] sm:border-4 transition-all duration-500 ${isActive
                            ...
                            {!isLast && (
                                <div
                                    className={`absolute top-5 bottom-[-6px] w-[2px] transition-colors duration-500 ${isActive && isNextActive
                                            ? "bg-green-500/40"
