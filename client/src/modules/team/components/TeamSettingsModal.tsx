...
interface TeamSettingsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUpdate: (data: TeamSettingsData) => void;
  isLoading: boolean;
  initialData: Partial<TeamSettingsData> | null;
}
...
export const TeamSettingsModal = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (typeof onUpdate === "function") {
      ...
      console.error(
        "Error: onUpdate prop is not provided to TeamSettingsModal",
      );
    }
  };
