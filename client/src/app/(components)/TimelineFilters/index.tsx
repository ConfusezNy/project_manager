    ...
    <>
      ...
      <div className="flex flex-wrap items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-0 mb-6 gap-4">
        <div className="flex gap-8 text-sm font-semibold">
          ...
          <button onClick={() => setActiveTab('documents')} className={`pb-4 border-b-2 transition-colors ${activeTab === 'documents' ? 'text-blue-600 border-blue-600 dark:text-blue-400' : 'text-gray-500 border-transparent'}`}>เอกสารทั้งหมด</button>
        </div>
        ...
        <div className="flex items-center gap-3 mb-2">
           <div className="relative group">
              <div className="flex items-center gap-2 rounded-lg bg-white dark:bg-[#1c1c1e] border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-sm hover:bg-gray-50 dark:hover:bg-[#2c2c2e]">
                ...
                <span className="text-gray-700 dark:text-gray-300">ปีการศึกษา:</span>
                <select value={selectedYear} onChange={(e) => setSelectedYear(e.target.value)} className="appearance-none bg-transparent font-semibold text-blue-600 dark:text-blue-400 focus:outline-none cursor-pointer pr-1">
           ...
           <div className="relative group">
              <div className="flex items-center gap-2 rounded-lg bg-white dark:bg-[#1c1c1e] border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-sm hover:bg-gray-50 dark:hover:bg-[#2c2c2e]">
                ...
                <select value={studentType} onChange={(e) => setStudentType(e.target.value)} className="appearance-none bg-transparent text-gray-700 dark:text-gray-300 focus:outline-none cursor-pointer pr-1">
