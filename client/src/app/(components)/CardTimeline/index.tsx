...
const CardTimeline: React.FC<CardTimelineProps> = ({ 
  ...
  return (
    <div className="group flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl p-5 transition-all duration-300 
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        {/* Week Number */}
        <div className="w-10 sm:w-12 text-center text-4xl sm:text-5xl font-bold 
