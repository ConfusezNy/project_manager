'use client' // ต้องอยู่บรรทัดที่ 1 เท่านั้น
...
export default function SignUp() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // สมัครสำเร็จ ส่งไปหน้า login (ตรวจสอบชื่อโฟลเดอร์ให้ตรงกับ /singin หรือ /login)
      router.push('/singin') 
    } catch (err: any) {
    ...
    <div className="min-h-screen flex font-sans text-gray-900 bg-white">
      ...
      <div className="hidden lg:flex relative w-0 flex-1 overflow-hidden bg-gray-900 items-center justify-center">
        ...
        <div className="relative z-10 p-12 max-w-2xl">
          <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-500/20 backdrop-blur-sm border border-blue-400/30 text-blue-400 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
      ...
      {/* === Right Side (Form) === */}
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-24 xl:px-32 relative overflow-hidden bg-white">
        <div className="mx-auto w-full max-w-sm lg:w-[420px] relative z-10">
          <div className="text-center lg:text-left mb-8">
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">สร้างบัญชีใหม่</h2>
            <p className="mt-3 text-base text-slate-500">กรุณากรอกข้อมูลเพื่อลงทะเบียนเข้าสู่ระบบ</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 bg-slate-50 border border-transparent rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                  placeholder="สมชาย"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700">อีเมลนักศึกษา</label>
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-3 bg-slate-50 border border-transparent rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-sm"
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-slate-500">
                มีบัญชีอยู่แล้ว?{' '}
                <Link href="/singin" className="font-bold text-blue-600 hover:underline">
                  เข้าสู่ระบบ
                </Link>
              </p>
            </div>
